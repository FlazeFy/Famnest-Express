...
export class UserRepository {
    ...
    public findUserByEmailRepo = async (email: string) => prisma.user.findUnique({ where: { email }})

    public findUserByIdRepo = async (id: string) => prisma.user.findUnique({ where: { id }})
}